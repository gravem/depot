...
puts 'populating Product database with new data from seed.db'
...
Product.create!(title: 'Modern CSS with Tailwind',
  ...
  price: 18.95)
  Product.create!(title: 'Gnomes goggles of prying 🥽',
  description:
    %{<p>
    <em>These bad boys</em> will let you see the fabrics of reality* when you put them on. And if worn while coding, you will be able to see how everything is connected!
    </p>},
  image_url: 'goggles.jpg',
  price: 189789.95)

  puts "database repopulated"
